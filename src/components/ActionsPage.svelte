                  ...
                  <Content>
                    {#if INSTALL_WALLET_URL}
                      ...
                      <p class="to-install-wallet">
                        👉 Препоръчваме да отворите връзката по-горе
                        на смартфона си. Портфейлът за дигитални
                        валути изисква отделна регистрация, но можете
                        да използвате същия имейл адрес.
                      </p>
                    {:else}
                      <p>
                        За да издадете и разполагате с каквато искате
                    ...
                    <p>
                      <strong>Важно:</strong>
                      За да видите QR кода на валутата си, можете да използвате бутона
                      <Icon class="material-icons" style="margin: 0 0.15em; vertical-align: middle">settings_applications</Icon>
                      по-долу. За да сканирате QR кода, ще трябва да
                      го отпечатате на хартия или да го отворите на
                      друго устройство.
                    </p>
                  </Content>
                </Paper>
